...
#   WITHOUT WARRANTIES OR CONDITIONS OF ANYx KIND, either express or implied.
#   See the License for the specific language gosverning permissions and
...
# appropriate HTTPS headers so that when the xproxies send span information, the
